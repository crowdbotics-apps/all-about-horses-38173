"""
Django settings for all_about_horses_38173 project.
...
ROOT_URLCONF = 'all_about_horses_38173.urls'
...
WSGI_APPLICATION = 'all_about_horses_38173.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "all_about_horses_38173 API",
    "DESCRIPTION": "API documentation for all_about_horses_38173 App",
    "VERSION": "v1",
}
